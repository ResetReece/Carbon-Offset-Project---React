  ...
  return (
    <div className="page">
      ...
      <div className="title-box">
        <h1 className="company-name">Privacy Policy</h1>
      </div>
      ...
      <div className="background-container">
        ...
        <p>When you subscribe to our services, third-party providers will be authorised to process your payment information. In these situations, we do not have access to your payment details. Instead, the third-party processors responsible for your payments, will have access to your data:</p>
        <ul>
          <li>Stripe</li>
          <li>PayPal</li>
        </ul>
        ...
        <p>Our site collects certain information automatically, including your IP address, the type of browser you are using, and certain other non-personal data about your computer or device such as your operating system type or version, and display resolution. You can remove or reject cookies using your browser or device settings, but in some cases doing so may affect your ability to use our products and services.</p>
        ...
        <p>Please note that these service providers only have access to your personal information to perform the tasks we have assigned to them, and they are obligated not to disclose or use it for any other purpose.</p>
        <p>Some of these third-party service providers may track your online behaviour over time and across different internet websites or online services. However, we do not have control over their data collection practices or the use of your personal information. Therefore, we encourage you to review their privacy policies before consenting to the use of their services on our website.</p>
        <p>We share or disclose your personal information with the following third-party service providers.</p>

        <h3>Analytics</h3>
        <p>We use a 3rd party analytical software to gather statistical information about our website visitors. The services we use include:</p>
        <ul>
          <li>SourceBuster</li>
        ...
        <p>The duration for which we retain each specific category of personal data depends on the processing purpose for which it was collected. We will store your personal data only for as long as it is necessary to fulfil the specific processing purpose for that category of data. Following the deletion of your personal information from our database, the related backup data will be deleted, generally within 1 day.</p>
        ...
        <p>In compliance with the General Data Protection Regulation (GDPR) principles, Rooted Offsets commits to the resolution of complaints and our collection or use of your information. We have also committed to resolving any complaints pursuant to the General Data Protection Regulation (GDPR) by EU, UK, and Swiss individuals with inquiries or complaints regarding our GDPR policy should first contact Rooted Offsets at: gdpr@rootedoffsets.com.</p>

        <h3>What Are Your Rights as the Owner of Personal Information</h3>
        ...
        <ul>
          ...
          <li>The right to opt-out</li>
          <li>The right to lodge a complaint to the relevant data protection authority</li>
        </ul>
        ...
        <h3>How Can You Exercise Your Rights as the Owner of Personal Information</h3>
        <p>If you would like to exercise your rights under the state law, you may submit your requests to us through the following channels:</p>
        <p>Email: stabrizi@rootedoffsets.com</p>
        <p>Website: <a href="https://rootedoffsets.com">https://rootedoffsets.com</a></p>
        ...
        <p>For any questions or inquiries concerning how Rooted Offsets addresses its obligations and your rights under the CPRA, including your rights to know, delete, correct, opt-out of your personal information, and limit the use and disclosure of your sensitive personal information, please email cpra@rootedoffsets.com or click here to contact us via our request form.</p>

        <h3>Location and Transfer of Your Personal Information</h3>
        <p>We utilise several third-party service providers, including:</p>
        <ul>
          <li>Metorik</li>
        </ul>
        <p>These providers are considered our data processors and are contractually bound to keep your personal information secure and confidential. They may only use your data for the purposes outlined in our agreement with them.</p>
        <p>We store your data in the following locations:</p>
        <ul>
          <li>United States of America</li>
        </ul>
        <p>However, some of these third-party service providers may be located in countries outside these locations. In such cases, we ensure that your data is transferred based on appropriate safeguards, such as adequacy decisions, standard contract clauses, or another transfer tool. We take all reasonable steps to ensure that your data is treated securely and that no transfer of your personal data will take place to an organization or a country unless adequate controls are in place to safeguard your data and other personal information. We are committed to maintaining the security of your personal information and protecting your privacy rights.</p>

        <h3>Security of Your Personal Information</h3>
        <p>We understand how important it is to keep your personal information secure. To protect your data, we implement the following technical measures:</p>
        <ul>
          <li>Encryption</li>
          <li>Two-factor authentication</li>
          <li>Backups</li>
          <li>Firewalls & malware protection</li>
        </ul>
